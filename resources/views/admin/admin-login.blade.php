    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url('/images/backend-images/big/auth-bg.jpg') no-repeat center center;">
            <div class="auth-box">
                ...
                <div id="loginform">
                    <div class="logo">
                        <span class="db"><img src="{{ asset('images/backend-images/app-logo/'.$app_settings->app_logo) }}" width="150" alt="logo" /></span>
                        <h5 style="margin-top: 15px;" class="font-medium mb-3">Sign In to Admin</h5>
                    </div>
                    <!-- Form -->
                    <div class="row">
                        <div class="col-12">
